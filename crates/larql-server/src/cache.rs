...
mod tests {
    ...
    fn coherence_is_part_of_the_key() {
        ...
        let raw = DescribeCache::key_scoped(
            None,
            "m",
            "Paris",
            "all",
        ...
        let rel = DescribeCache::key_scoped(
            None,
            "m",
            "Paris",
            "all",
        ...
        let vocab = DescribeCache::key_scoped(
            None,
            "m",
            "Paris",
            "all",
        ...
        assert_ne!(
            vocab, emb,
            "backgrounds rank differently and must not share an entry"
        );
    }

    #[test]
    fn key_scoped_separates_sessions_and_global() {
        let global = DescribeCache::key_scoped(
            None,
            "m",
            "Paris",
            "all",
